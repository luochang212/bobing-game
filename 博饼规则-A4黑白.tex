...
\textbf{结束：}除状元外的 62 份奖品发完后，完成当前一轮（至首位玩家的前一位掷完），再定状元。若此时仍无人博到状元，加赛最后一轮；该轮过后仍无人博到，则每人再掷一次，掷出状元的按第三节比，都未掷出比六颗点数总和，最大者得状元奖，总和相同者再掷，直至分出。

\vspace{7pt}\hrule height 0.4pt\vspace{5pt}
{\fontsize{10}{15}\selectfont
桌号：\underline{\hspace{1.2cm}}\quad 状元：\underline{\hspace{2.4cm}}\quad 点数（六颗）：\underline{\hspace{3.4cm}}\par}
\vspace{3pt}
