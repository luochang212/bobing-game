% !TEX program = xelatex
% -*- coding: utf-8 -*-
% 版本：flexible-grand-final——奖品若干（先留 1 份作状元奖），各桌独立博饼，
% 各桌状元晋级全场"状元王"加赛。规则族：pooled，桌内规则与 flexible 一致。
...
\vspace{3pt}
{\fontsize{9}{12}\selectfont 各桌独立博饼，博出的状元晋级全场“状元王”加赛，安排见扫码页。奖品可用月饼或礼品，祝大家中秋快乐！\par}
\end{document}
