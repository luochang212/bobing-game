% !TEX program = xelatex
% -*- coding: utf-8 -*-
% 版本：flexible——奖品若干（总数与分档数量以现场为准，先留 1 份作状元奖），
% 单桌多桌通用，无全场环节。规则族：pooled，与 fixed63 共享判定与状元体系。
...
\begin{minipage}[c]{0.79\linewidth}
  ...
  \vspace{7pt}
  {\fontsize{10.5}{14.5}\selectfont 每桌：\textbf{6 颗骰子 · 1 个大碗 · 奖品若干份，先留 1 份作状元奖}\par}
\end{minipage}\hfill
...
{\fontsize{9.5}{13}\selectfont 黑底“4”表示四点，俗称“红四”。图中为\textbf{一组示例}，以文字条件为准，骰子排列顺序不限。状元以下五档为普通奖。\par}
\vspace{3pt}
{\renewcommand{\arraystretch}{1.28}
\begin{tabularx}{\linewidth}{p{2.35cm} >{\centering\arraybackslash}p{3.1cm} L}
\rowcolor{headgray}\tablehead{奖级} & \tablehead{骰面示例} & \tablehead{判定条件}\\
状元 & \roll{4}{4}{4}{4}{2}{6} & 至少 4 颗四点，或 5 颗以上同点；见第三节\\
对堂 & \roll{1}{2}{3}{4}{5}{6} & 1、2、3、4、5、6 各 1 颗\\
三红 & \roll{4}{4}{4}{1}{2}{5} & 恰有 3 颗四点\\
四进 & \roll{2}{2}{2}{2}{4}{6} & 恰有 4 颗同点，且该点数不是 4\\
二举 & \roll{4}{4}{1}{2}{5}{6} & 恰有 2 颗四点\\
一秀 & \roll{4}{1}{1}{2}{3}{5} & 恰有 1 颗四点\\
\end{tabularx}\par}
\vspace{3pt}
\textbf{本场不兼奖：}掷中普通奖领 1 份，不改领其他奖，领走的不追回；未列组合不中奖。\\
{\fontsize{9.5}{13}\selectfont 例：2、2、2、2、4、4 只算四进，不另领二举。\par}
...
\textbf{结束：}奖品领到只剩状元奖时，补完当前一轮，掷到首位玩家的前一位为止，再定状元。若仍无人博到状元，加赛最后一轮。加赛后仍无人博到，每人再掷一次。有人掷出状元，就按第三节比较；都未掷出，就比六颗点数总和。总和最大者得状元奖；总和相同者再掷，直至分出。
